        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            <div className="w-11 h-11 rounded-full bg-gradient-to-br from-zinc-800 to-zinc-900 border border-white/10 flex items-center justify-center shadow-inner relative overflow-hidden group">
              <span className="font-mono text-[10px] font-black text-gh-blue tracking-widest italic">
                DRH
              </span>
      ...
      >
        <AnimatePresence initial={false}>
          {displayedMessages.map((msg) => (
            ...
            >
              <div
                className={`max-w-[90%] p-4 rounded-2xl text-[13px] leading-relaxed shadow-xl italic ${
                  msg.sender === "HASSAN"
