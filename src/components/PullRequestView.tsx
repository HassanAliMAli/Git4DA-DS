    ...
    >
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3 mb-1">
              <span className="text-[11px] font-black text-gh-blue uppercase tracking-[0.3em]">
                Pull Request #1207
              </span>
              <span className="px-2 py-0.5 rounded-full bg-gh-green/10 border border-gh-green/20 text-[9px] font-black text-gh-green uppercase tracking-widest animate-pulse">
                Open
              </span>
            </div>
      ...
      <div className="flex-1 overflow-y-auto p-8 space-y-10 scrollbar-hide">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="text-zinc-600 font-mono text-[10px]">
                requested a merge into
              </span>
              <span className="text-gh-blue font-black font-mono text-[10px] bg-gh-blue/5 px-2 py-0.5 rounded">
                main
              </span>
            </div>
        ...
        <div className="space-y-4">
          <h3 className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.4em] italic border-b border-white/5 pb-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gh-green/5 border border-gh-green/20 p-4 rounded-2xl flex items-center gap-4">
              ...
              <div>
                ...
                <div className="text-[9px] text-gh-green font-bold uppercase tracking-widest">
                  12/12 PASSED
                </div>
              </div>
            </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-ink rounded-3xl p-8 border border-white/5 font-mono text-[13px] leading-relaxed shadow-inner overflow-hidden relative">
            ...
            <div className="space-y-1 relative z-10">
              ...
              <div className="text-gh-danger bg-gh-danger/5">
                - SELECT SUM(amount) FROM sales;
              </div>
              <div className="text-gh-green bg-gh-green/5">
                + SELECT SUM(amount) * 1.05 FROM sales WHERE region = "US";
              </div>
              <div className="text-gh-green bg-gh-green/5">
                + -- Resolved conflict: Merged US filter with global tax logic
              </div>
            </div>
          </div>
        </div>
