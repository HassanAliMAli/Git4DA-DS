    ...
    <section className="relative overflow-hidden border-b border-white/5 grid-bg">
      ...
      <div className="w-full px-6 sm:px-10 lg:px-16 py-24 lg:py-32 relative flex flex-col items-center text-center">
        <div className="max-w-6xl flex flex-col items-center">
          ...
          >
            <span className="px-1.5 py-0.5 rounded bg-gh-blue text-white font-black font-mono text-[9px] tracking-widest uppercase">
              ACTIVE
            </span>
            <span className="text-white font-mono text-[10px] uppercase tracking-widest font-black italic opacity-90">
              Meta & Google internal patterns declassified
            </span>
            <span className="hidden sm:inline text-zinc-700">•</span>
            <span className="hidden sm:inline text-white font-mono italic font-bold uppercase tracking-widest text-[9px]">
              20 LEVELS • 0 TO LEGENDARY
            </span>
          </motion.div>
          ...
          >
            ...
            <span className="relative inline-block px-4">
              <span className="bg-gradient-to-r from-white via-zinc-200 to-gh-blue bg-clip-text text-transparent italic text-[1.05em] font-black underline decoration-gh-blue/20 underline-offset-8">
                integrity
              </span>
          ...
          >
            Not a tutorial. A high-fidelity simulation of the environments where
            trillion-row decisions ship daily. You will learn to recover work
            others consider lost forever, and to sign every byte that touches
            production.
          </motion.p>
            ...
            <div className="flex items-start gap-6 text-left">
              ...
              <div className="min-w-0">
                <div className="flex flex-wrap items-baseline gap-x-4 gap-y-1 mb-4">
                  <h2 className="text-[14px] font-black tracking-[0.2em] text-gh-blue uppercase italic underline decoration-gh-blue/30">
                    DR. HASSAN • THE SAGE OF DATAPULSE
                  </h2>
                  <span className="text-[10px] px-2 py-0.5 rounded-md bg-gh-warn/15 text-gh-warn border border-gh-warn/20 font-mono font-black uppercase tracking-widest italic">
                    FORMER STAFF ENG • META
                  </span>
                </div>
                <blockquote className="text-[18px] leading-[1.6] text-white font-medium italic border-l-2 border-white/5 pl-6 py-1">
                  “A junior analyst trusts their memory. A professional trusts
                  their code.
                  <strong className="text-gh-blue font-black not-italic px-1 underline decoration-gh-blue/50 decoration-2 italic">
                    A Legend trusts the Reflog.
                  </strong>
                  Welcome to the final tier of data science — where history is
                  engineered, not recorded.”
                </blockquote>
                <div className="mt-5 flex items-center gap-5 text-[11px] text-zinc-500 font-mono italic font-black uppercase tracking-[0.2em]">
                  ...
                  <span className="text-gh-green animate-pulse">
                    • STATUS: ONLINE
                  </span>
                </div>
              </div>
            ...
            {[
              ...
              >
                <div className="flex items-start gap-4">
                  <div
                    className={`mt-0.5 w-11 h-11 rounded-xl bg-ink border border-white/10 flex items-center justify-center flex-shrink-0 group-hover:border-white/20 transition-colors shadow-glow`}
                  >
                    {item.icon}
                  </div>
                  <div>
                    <div className="text-[11px] font-black tracking-[0.3em] text-white mb-2 uppercase italic">
                      {item.title}
                    </div>
                    <div className="text-[14px] leading-[1.6] text-white font-medium italic opacity-90">
                      {item.desc}
                    </div>
                  </div>
                </div>
