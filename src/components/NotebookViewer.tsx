            ...
            >
              {cell.cell_type === "markdown" ? (
                <div className="flex items-start gap-4">
                  <MessageSquare
                    size={14}
                    className="text-gh-blue mt-1 shrink-0 opacity-40"
                  />
                ...
                <div className="font-mono text-[13px] text-white/90 whitespace-pre-wrap italic">
                  ...
                  {cell.outputs && cell.outputs.length > 0 && (
                    <div className="mt-6 pt-6 border-t border-white/5 font-sans not-italic">
                      <div className="text-[10px] font-black text-zinc-600 uppercase tracking-widest mb-3 italic">
                        Output
                      </div>
                      <div className="bg-ink rounded-xl p-4 border border-white/5 text-gh-green opacity-80 text-xs">
                        {cell.outputs[0].text
                          ? cell.outputs[0].text.join("")
                          : "Object data rendered."}
                      </div>
                    </div>
                  )}
                </div>
