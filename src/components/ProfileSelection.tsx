      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-[18px] text-gh-text-sec font-light max-w-2xl mx-auto italic border-l border-white/5 pl-8">
            Identify yourself and select your technical trajectory. Your actions
            from this point forward will be cryptographically signed.
          </p>
        </div>
        ...
        <div className="bg-ink-2 border border-gh-border rounded-[32px] shadow-2xl overflow-hidden transition-all duration-500 hover:border-white/10">
          <div className="flex items-center px-8 py-5 bg-ink-3 border-b border-gh-border">
            <ShieldAlert
              size={16}
              className="text-gh-warn mr-4 animate-pulse"
            />
            <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-[0.3em] font-black italic">
          ...
          <form onSubmit={handleSubmit} className="p-10 md:p-16">
            <div className="mb-16">
              <label
                htmlFor="name"
                className="block text-[10px] font-black text-gh-blue uppercase tracking-[0.4em] mb-4 italic"
              >
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                >
                  ...
                  <p className="text-[13px] text-zinc-500 font-light leading-relaxed mb-6 italic">
                    Master Logic, insights, and Analytics Engineering. Version
                    SQL pipelines and ensure perfectly reproducible dashboard
                    states.
                  </p>
                  <div className="flex gap-3">
                    <span className="text-[8px] font-black font-mono px-2 py-1 rounded-md bg-ink border border-white/5 text-zinc-700 uppercase italic">
                      SQL.v2
                    </span>
                    <span className="text-[8px] font-black font-mono px-2 py-1 rounded-md bg-ink border border-white/5 text-zinc-700 uppercase italic">
                      dbt.eng
                ...
                >
                  ...
                  <p className="text-[13px] text-zinc-500 font-light leading-relaxed mb-6 italic">
                    Master models, experiments, and MLOps. Version massive
                    datasets (DVC) and cryptographically secure your production
                    lineage.
                  </p>
                  <div className="flex gap-3">
                    <span className="text-[8px] font-black font-mono px-2 py-1 rounded-md bg-ink border border-white/5 text-zinc-700 uppercase italic">
            ...
            <div className="flex flex-col items-center pt-10 border-t border-white/5">
              ...
              >
                {isIssuing ? (
                  ...
                  <>
                    ...
                    <ChevronRight
                      size={20}
                      className="group-hover:translate-x-1 transition-transform text-gh-blue"
                    />
                  </>
                )}
              ...
              <div className="mt-8 flex items-center gap-3 text-[10px] font-mono text-zinc-700 uppercase tracking-[0.4em] italic font-black">
                <Lock size={12} className="text-gh-blue/50" /> End-to-End
                Encrypted Handshake
              </div>
            </div>
          </form>
